...
#$5 - product path                              //vendor/kaihong/khdvk_3566b
#$6 - product mk config file name               roc-rk3566-pc.mk
#$7 - device_name                               khdvk_3566b
...
# $4 $DEVICE_DIR :         /home/openharmony/device/board/kaihong/khdvk_3566b
# $5 $PRODUCT_PATH :       vendor/kaihong/khdvk_3566b
# $6 $CONFIG_FILE :        khdvk-rk3566.mk
...
cp -arfpL $BORAD_DIR/loader/parameter-fit.txt $KERNEL_BUILD_ROOT_DIR/device/rockchip/rk356x/parameter-fit.txt
