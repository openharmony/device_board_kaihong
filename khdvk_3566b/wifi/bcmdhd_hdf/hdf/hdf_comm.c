...
static int32_t __HdfStartScan(NetDevice *hhnetDev, struct WlanScanRequest *scanParam)
{
    int32_t ret = 0;
    struct net_device *ndev = NULL;
    struct wiphy *wiphy = NULL;
    ...
    HDF_LOGE("%s: enter hdfStartScan %s, channelTotal: %d, for %u", __func__, ndev->name, channelTotal, sizeof(struct ieeee80211_channel *));
