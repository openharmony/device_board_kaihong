...
typedef struct dhd_info {
    ...
    /* net_device interface lock, prevent race conditions among net_dev
     * interface calls and wifi_on or wifi_off
     */
     ...
     * 0) iteration 1 - 10 (the bin counter 2^4 increments to 1) iteration 2 -
     * 30 (the bin counter 2^5 increments to 1) iteration 3 - 15 (the bin
     * counter 2^4 increments by 1 to become 2)
     */
