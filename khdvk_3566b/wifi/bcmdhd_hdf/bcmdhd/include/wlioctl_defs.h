...
#define WL_RSPEC_OVERRIDE_RATE                                                 \
    0x40000000 /* bit indicate to override mcs only */
#define WL_RSPEC_OVERRIDE_MODE                                                 \
    0x80000000 /* bit indicates override rate & mode */

/* WL_RSPEC_ENCODING field defs */
#define WL_RSPEC_ENCODE_RATE                                                   \
    0x00000000 /* Legacy rate is stored in RSPEC_RATE_MASK */
#define WL_RSPEC_ENCODE_HT 0x01000000 /* HT MCS is stored in RSPEC_RATE_MASK   \
                                       */
#define WL_RSPEC_ENCODE_VHT                                                    \
    0x02000000 /* VHT MCS and Nss is stored in RSPEC_RATE_MASK */
...
#define HIGHEST_SINGLE_STREAM_MCS                                              \
    7 /* MCS values greater than this enable multiple streams */

#endif /* !USE_NEW_RSPEC_DEFS */

/* Legacy defines for the nrate iovar */
#define OLD_NRATE_MCS_INUSE                                                    \
    0x00000080 /* MSC in use,indicates b0-6 holds an mcs */
...
#define OLD_NRATE_OVERRIDE                                                     \
    0x80000000 /* bit indicates override both rate & mode */
...
#define CCA_ERRNO_DURATION 2 /* After filtering for duration, no choices left  \
                              */
#define CCA_ERRNO_PREF_CHAN                                                    \
    3 /* After filtering for chan pref, no choices left */
#define CCA_ERRNO_INTERFER                                                     \
    4 /* After filtering for interference, no choices left */
...
#define WL_STA_PS 0x00000100 /* STA is in power save mode from AP's viewpoint  \
                              */
#define WL_STA_APSD_BE                                                         \
    0x00000200 /* APSD delv/trigger for AC_BE is default enabled */
#define WL_STA_APSD_BK                                                         \
    0x00000400 /* APSD delv/trigger for AC_BK is default enabled */
#define WL_STA_APSD_VI                                                         \
    0x00000800 /* APSD delv/trigger for AC_VI is default enabled */
#define WL_STA_APSD_VO                                                         \
    0x00001000 /* APSD delv/trigger for AC_VO is default enabled */
...
#define WL_STA_CAP_MIMO_PS_RTS                                                 \
    0x0001 /* Mimo PS, send RTS/CTS around MIMO frames */
...
#define WL_STA_CAP_MAX_AMSDU                                                   \
    0x0800 /* Max AMSDU size in bytes , 0=3839, 1=7935 */
...
#define WL_STA_CAP_RX_STBC_ONE_STREAM                                          \
    0x1 /* rx STBC support of 1 spatial stream */
#define WL_STA_CAP_RX_STBC_TWO_STREAM                                          \
    0x2 /* rx STBC support of 1-2 spatial streams */
#define WL_STA_CAP_RX_STBC_THREE_STREAM                                        \
...
#define WL_SCAN_THROTTLE_OTHER_FW_SCAN                                         \
    (1U << 2) /* for other scans like pno etc */
...
#define WL_SCANFLAGS_SWTCHAN                                                   \
    0x20 /* Force channel switch for differerent bandwidth */
#define WL_SCANFLAGS_FORCE_PARALLEL                                            \
    0x40 /* Force parallel scan even when actcb_fn_t is on.                    \
...
#define WL_SCANFLAGS_LOW_POWER_SCAN                                            \
    0x1000 /* LOW power scan, scheduled scan                                   \
            * only on scancore                                                 \
            */
#define WL_SCANFLAGS_HIGH_ACCURACY                                             \
    0x2000 /* High accuracy scan, which needs                                  \
            * reliable scan results                                            \
            */
#define WL_SCANFLAGS_LOW_SPAN                                                  \
    0x4000 /* LOW span scan, which expects                                     \
...
#define SCANOL_CYCLE_IDLE_REST_TIME                                            \
    300000 /* Idle Rest Time between Scan Cycle (msec) */
...
#define SCANOL_MAX_REST_TIME                                                   \
    3600000                     /* max rest time between scan cycle (msec) */
...
#define SCANOL_NPROBES_MAX                                                     \
    5 /* for Active scan; send n probes on each channel */
...
#define SCANOL_UNASSOC_TIME_MAX                                                \
    100 /* max dwell on a channel while unassociated */
#define SCANOL_PASSIVE_TIME_MAX                                                \
    500                    /* max listen on a channel for passive scan */
...
#define WL_BSS_FLAGS_RSSI_ONCHANNEL                                            \
    0x04 /* rssi info received on channel (vs offchannel) */
...
#define WL_BSS_BCNFLAGS_INTERWORK_PRESENT                                      \
    0x01 /* beacon had IE, accessnet valid */
#define WL_BSS_BCNFLAGS_INTERWORK_PRESENT_VALID                                \
    0x02 /* on indicates support for this API */
#define WL_BSS_BCNFLAGS_MULTIPLE_BSSID_SET                                     \
    0x4 /* this AP belongs to a multiple BSSID set */
#define WL_BSS_BCNFLAGS_NONTRANSMITTED_BSSID                                   \
    0x8 /* this AP is the transmitted BSSID */
...
#if defined(BCMCCX) || defined(BCMEXTCCX)
#define KEY_ALGO_MASK_CCX                                                      \
    (KEY_ALGO_MASK(CRYPTO_ALGO_CKIP) | KEY_ALGO_MASK(CRYPTO_ALGO_CKIP_MMH) |   \
     KEY_ALGO_MASK(CRYPTO_ALGO_WEP_MMH))
#endif /* defined(BCMCCX) || defined(BCMEXTCCX) */

#define KEY_ALGO_MASK_WEP                                                      \
    (KEY_ALGO_MASK(CRYPTO_ALGO_WEP1) | KEY_ALGO_MASK(CRYPTO_ALGO_WEP128) |     \
     KEY_ALGO_MASK(CRYPTO_ALGO_NALG))

#define KEY_ALGO_MASK_AES                                                      \
...
#define WL_PRIMARY_KEY                                                         \
    (1 << 1) /* Indicates this key is the primary (ie tx) key */
#if defined(BCMCCX) || defined(BCMEXTCCX)
...
#endif                       /* BCMCCX || BCMEXTCCX */
#define WL_IBSS_PEER_GROUP_KEY                                                 \
    (1 << 6)                   /* Indicates a group key for a IBSS PEER */
...
#define SES_OW_ENABLED                                                         \
    0x0040 /* to go into transition mode without setting wep */
#ifdef BCMWAPI_WPI
...
#define MFP_SHA256                                                             \
    0x0800 /* a special configuration for STA for WIFI test tool */
...
#define WPA2_AUTH_IS_FILS(auth)                                                \
    ((auth) & (WPA2_AUTH_FILS_SHA256 | WPA2_AUTH_FILS_SHA384))
...
#define WPA3_AUTH_SAE_AP_ONLY                                                  \
    0x1000000 /* SAE restriction to connect to pure SAE APs */
/* WPA2_AUTH_SHA256 not used anymore. Just kept here to avoid build issue in
 * DINGO */
...
#else
#define WLC_SAMPLECOLLECT_MAXLEN                                               \
    10240 /* Max Sample Collect buffer for two cores */
#endif    // endif
#define WLC_SAMPLECOLLECT_MAXLEN_LCN40 8192

#define WLC_IOCTL_NANRESP_MAXLEN                                               \
    4096u /* "max" length nan ioctl resp buffer required */
#define WLC_IOCTL_NANRESP_MEDLEN                                               \
    800u /* "med" length nan ioctl resp buffer required */
...
#define WL_AUTH_FILS_SHARED_PFS                                                \
    5                         /* d11 fils shared key w/ pfs authentication */
...
#define WL_DIAGERR_MEMORY_TIMEOUT 11 /* d11 memory test didn't finish in time  \
                                      */
#define WL_DIAGERR_MEMORY_BADPATTERN                                           \
    12 /* d11 memory test result in bad pattern */
 ...
 *					Preamble: Long
 *					Shortslot: On
 * GMODE_PERFORMANCE			Rateset: 1b, 2b, 5.5b, 6b, 9, 11b, 12b, 18, 24b, 36,
 * 48, 54 Preamble: Short required Shortslot: On and required GMODE_LRS
 * Rateset: 1b, 2b, 5.5b, 11b Extended Rateset: 6, 9, 12, 18, 24, 36, 48, 54
 *					Preamble: Long
 *					Shortslot: Auto
 */
...
#define WLC_BW_CAP_80MHZ                                                       \
    (WLC_BW_80MHZ_BIT | WLC_BW_40MHZ_BIT | WLC_BW_20MHZ_BIT)
...
#define WL_RADAR_SIMULATED                                                     \
    2 /* force radar detector to declare                                       \
       * detection once                                                        \
       */
#define WL_RADAR_SIMULATED_SC                                                  \
    3                         /* force radar detector to declare               \
...
#define BCMIO_NBBY 8
#define WL_EVENTING_MASK_LEN                                                   \
    (16 + 4) /* Don't increase this without wl review */
...
#define WL_JOIN_PREF_RSSI_DELTA                                                \
    4 /* by 802.11 band only if RSSI delta condition matches */
#define WL_JOIN_PREF_TRANS_PREF 5 /* defined by requesting AP */

/* band preference */
#define WLJP_BAND_ASSOC_PREF                                                   \
    255 /* use what WLC_SET_ASSOC_PREFER ioctl specifies */
...
/* SPECT_MNGMT_LOOSE_11H_D - same as SPECT_MNGMT_LOOSE with the exception that
 * Country IE adoption is done regardless of capability spectrum_management
 */
#define SPECT_MNGMT_LOOSE_11H_D 4 /* operation defined above */

/* bit position in per_chan_info; these depend on current country/regulatory
 * domain */
...
#define WL_CHAN_RADAR_EU_WEATHER                                               \
    (1u << 7) /* EU Radar weather channel.                                     \
               * Implies an EU Radar channel.                                  \
               */
#define WL_CHAN_CLM_RESTRICTED                                                 \
    (1u << 8) /* channel restricted in CLM (i.e. by default) */
#define WL_CHAN_BAND_6G (1u << 9) /* 6GHz-band channel */
#define WL_CHAN_OOS_SHIFT 24u     /* shift for OOS field */
#define WL_CHAN_OOS_MASK                                                       \
    0xFF000000u /* field specifying minutes remaining for this                 \
...
#define WL_BTC_PARALLEL                                                        \
    4 /* BT and WLAN run in parallel with separate antenna  */
#define WL_BTC_HYBRID                                                          \
    5 /* hybrid coex, only ack is allowed to transmit in BT slot */
...
#define WL_PKT_FILTER_BASE_NAMES                                               \
    {"START", WL_PKT_FILTER_BASE_PKT}, {"END", WL_PKT_FILTER_BASE_END},        \
...
#define NUM_80211_RATES                                                        \
    (NUM_80211b_RATES + NUM_80211ag_RATES + NUM_80211n_RATES)
...
#define WL_WOWL_ULP_BAILOUT                                                    \
    (1 << 8) /* wakeind via unknown pkt by basic ULP-offloads -                \
              * WL_WOWL_ULP_BAILOUT - same as WL_WOWL_PME_GPIO used only for   \
              * DONGLE BUILDS                                                  \
              */
#define WL_WOWL_NEEDTKIP1                                                      \
    (1 << 9) /* need tkip phase 1 key to be updated by the driver */
...
#define WL_WOWL_BCAST                                                          \
    (1 << 15) /* If the bit is set, frm received was bcast frame */
#define WL_WOWL_SCANOL                                                         \
    (1 << 16) /* If the bit is set, scan offload is enabled */
...
#define WL_WOWL_ENAB_HWRADIO                                                   \
    (1 << 22) /* Enable detection of radio button changes */
#define WL_WOWL_MIC_FAIL (1 << 23) /* Offloads detected MIC failure(s) */
#define WL_WOWL_UNASSOC                                                        \
    (1 << 24) /* Wakeup in Unassociated state (Net/Magic Pattern) */
#define WL_WOWL_SECURE                                                         \
    (1 << 25) /* Wakeup if received matched secured pattern */
...
#define MAGIC_PKT_MINLEN                                                       \
    102 /* Magic pkt min length is 6 * 0xFF + 16 * ETHER_ADDR_LEN */
...
#define WL_MIN_NUM_OBSS_SCAN_ARG                                               \
    7 /* minimum number of arguments required for OBSS Scan */
...
#define MAX_ARGSTR_LEN                                                         \
    18 /* At least big enough for storing ETHER_ADDR_STR_LEN */
...
#define VNDR_IE_IWAPID_FLAG                                                    \
    0x40 /* vendor IE in IW advertisement protocol ID field */
...
/* schedule option - WL_P2P_SCHED_TYPE_REQ_ABS */
#define WL_P2P_SCHED_OPTION_TSFOFS                                             \
    2 /* normal start/internal/duration/count with                             \
...
#define WL_P2P_FEAT_GO_CSA (1 << 0) /* GO moves with the STA using CSA method  \
                                     */
#define WL_P2P_FEAT_GO_NOLEGACY                                                \
    (1 << 1) /* GO does not probe respond to non-p2p probe                     \
              * requests                                                       \
              */
#define WL_P2P_FEAT_RESTRICT_DEV_RESP                                          \
    (1 << 2) /* Restrict p2p dev interface from responding */
...
#define CHANNEL_5G_LOW_START                                                   \
    36 /* 5G low (36..48) CDD enable/disable bit mask */
#define CHANNEL_5G_MID_START                                                   \
    52 /* 5G mid (52..64) CDD enable/disable bit mask */
#define CHANNEL_5G_HIGH_START                                                  \
    100 /* 5G high (100..140) CDD enable/disable bit mask */
#define CHANNEL_5G_UPPER_START                                                 \
    149 /* 5G upper (149..161) CDD enable/disable bit mask */
...
#define TRF_MGMT_FLAG_MANAGE_LOCAL_TRAFFIC                                     \
    0x0008 /* Manage traffic over our local subnet */
...
#define TRF_FILTER_MAC_ADDR                                                    \
    0x0001 /* L2 filter use dst mac address for filtering */
...
#define BRCM_WNM_FEATURE_SET                                                   \
    (WL_WNM_PROXYARP | WL_WNM_SLEEP | WL_WNM_FMS | WL_WNM_TFS | WL_WNM_TIMBC | \
     WL_WNM_BSSTRANS | WL_WNM_DMS | WL_WNM_NOTIF | 0)
#endif /* WLWNM_BRCM */
...
#define WL_WLAN_ASSOC_REASON_ROAM_FROM_CELLULAR_NETWORK                        \
    1                                        /* roam from Cellular network */
...
#endif                          /* WLAFTERBURNER */
#define WL_SWFL_NOHWRADIO                                                      \
    0x0004 /* Disable HW Radio monitor (e.g., Cust Spec) */
...
#define WLC_ROAM_TRIGGER_BANDWIDTH                                             \
...
#define WLC_ROAM_NEVER_ROAM_TRIGGER                                            \
    (-100) /* Avoid Roaming by setting a large value */
...
#define PNO_SCAN_MAX_FW_SEC                                                    \
    PNO_SCAN_MAX_FW / 1000     /* max time scan time in SEC */
#define PNO_SCAN_MIN_FW_SEC 10 /* min time scan time in SEC */
#define WL_PFN_HIDDEN_MASK 0x4
#define MAX_SSID_ALLOWLIST_NUM 4
#define MAX_BSSID_PREF_LIST_NUM 32
#define MAX_BSSID_DENYLIST_NUM 32
...
#define WL_RELMCAST_FLAG_INDENYLIST 1
...
#define WL_RADIO_COUNTRY_DISABLE                                               \
    (1 << 3) /* some countries don't support any channel */
#define WL_RADIO_PERCORE_DISABLE (1 << 4) /* Radio diable per core for DVT */
#define WL_RADIO_TSYNC_PWRSAVE_DISABLE                                         \
    (1 << 5) /* Disable Radio in tsync mode for power saving */
...
#define WLC_FBT_CAP_DRV_4WAY_AND_REASSOC                                       \
    1 /* Driver 4-way handshake & reassoc (WLFBT). */
...
#define MAX_WFDS_SEEK_SVC_INFO_LEN                                             \
    255 /* maximum seek service_info req length */
...
#define WL_PWRSTATS_TYPE_CONNECTION                                            \
    4 /* struct wl_pwr_connect_stats; assoc and key-exch time */
...
#define WL_PWRSTATS_TYPE_SLICE_INDEX                                           \
    10 /* slice index for which this report is meant for */
...
#define WL_PWRSTATS_TYPE_SLICE_INDEX_BAND_INFO                                 \
    14                                 /* wl_pwr_slice_index_band_t */
...
#define CTMODE_DBG_MPDU_THRESHOLD_MASK                                         \
    ((0x1FFu) << CTMODE_DBG_MPDU_THRESHOLD_SHIFT)
#define CTMODE_DBG_BYTES_THRESHOLD_SHIFT (16u)
#define CTMODE_DBG_BYTES_THRESHOLD_MASK                                        \
    ((0xFFFu) << CTMODE_DBG_BYTES_THRESHOLD_SHIFT)
