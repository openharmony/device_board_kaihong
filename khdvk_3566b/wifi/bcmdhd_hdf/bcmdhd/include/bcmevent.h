...
/*
 * used by host event
 * note: if additional event types are added, it should go with
...
#define BCM_MSG_LEN                                                            \
    (sizeof(bcm_event_t) - sizeof(bcmeth_hdr_t) - sizeof(struct ether_header))
...
#define WLC_E_AUTOAUTH                                                         \
    24 /* report AutoAuth table entry match for join attempt */
...
#define WLC_E_UNICAST_DECODE_ERROR 50 /* Unsupported unicast encrypted frame   \
                                       */
#define WLC_E_MULTICAST_DECODE_ERROR                                           \
    51 /* Unsupported multicast encrypted frame */
...
#define WLC_E_ACTION_FRAME_OFF_CHAN_COMPLETE                                   \
    70                           /* action frame off channel complete */
#define WLC_E_PROBRESP_MSG 71    /* probe response received */
#define WLC_E_P2P_PROBREQ_MSG 72 /* P2P Probe request received */
#define WLC_E_DCS_REQUEST 73
#define WLC_E_FIFO_CREDIT_MAP                                                  \
    74 /* credits for D11 FIFOs. [AC0,AC1,AC2,AC3,BC_MC,ATIM] */
#define WLC_E_ACTION_FRAME_RX                                                  \
    75 /* Received action frame event WITH                                     \
        * wl_event_rx_frame_data_t header                                      \
        */
#define WLC_E_WAKE_EVENT                                                       \
    76 /* Wake Event timer fired, used for wake WLAN test mode */
...
#define WLC_E_TDLS_PEER_EVENT                                                  \
    92 /* discovered peer, connected/disconnected peer */
...
#define WLC_E_TXFAIL_THRESH                                                    \
    108                 /* Indication of MAC tx failures (exhaustion of        \
...
#define WLC_E_ALLOW_CREDIT_BORROW                                              \
    117                /* Allow or disallow wlfc credit borrowing in DHD */
...
#define WLC_E_PFN_GSCAN_FULL_RESULT                                            \
    134 /* Full probe/beacon (IEs etc) results */
#define WLC_E_PFN_SWC                                                          \
    135 /* Significant change in rssi of bssids being tracked */
#define WLC_E_AUTHORIZED 136 /* a STA been authroized for traffic */
#define WLC_E_PROBREQ_MSG_RX                                                   \
    137 /* probe req with wl_event_rx_frame_data_t header */
...
#define WLC_E_DMA_TXFLUSH_COMPLETE                                             \
    165                            /* TxFlush done before changing tx/rxchain */
...
#define WLC_E_GTK_KEYROT_NO_CHANSW                                             \
    179 /* Avoid Chanswitch while GTK key rotation */
...
#define WLC_E_ACTION_FRAME_OFF_CHAN_DWELL_COMPLETE                             \
    185                /* action frame off channel                             \
                        *  dwell time complete                                 \
                        */
...
#define WLC_E_STATUS_ATTEMPT                                                   \
    7 /* attempt to assoc to an auto auth configuration */
#define WLC_E_STATUS_PARTIAL 8   /* scan results are incomplete */
#define WLC_E_STATUS_NEWSCAN 9   /* scan aborted by another scan */
#define WLC_E_STATUS_NEWASSOC 10 /* scan aborted due to assoc in progress */
#define WLC_E_STATUS_11HQUIET 11 /* 802.11h quiet period started */
#define WLC_E_STATUS_SUPPRESS                                                  \
    12 /* user disabled scanning (WLC_SET_SCANSUPPRESS) */
...
#define WLC_E_STATUS_SLOTTED_PEER_ADD                                          \
    17 /* Slotted scb for peer addition status */
#define WLC_E_STATUS_SLOTTED_PEER_DEL                                          \
    18                        /* Slotted scb for peer deletion status */
#define WLC_E_STATUS_RXBCN 19 /* Rx Beacon event for FAKEAP feature	*/
#define WLC_E_STATUS_RXBCN_ABORT                                               \
    20 /* Rx Beacon abort event for FAKEAP feature */
#define WLC_E_STATUS_LOWPOWER_ON_LOWSPAN                                       \
    21                            /* LOWPOWER scan request during LOWSPAN */
...
typedef struct wl_event_sdb_data {
    ...
    char ssidbuf[(4 * 32) +
                 1]; /* SSID_FMT_BUF_LEN: ((4 * DOT11_MAX_SSID_LEN) + 1) */
} wl_event_sdb_data_t;
...
#define WLC_E_GTKKEYROT_SKIPCHANSW_P2P                                         \
    2 /* Avoid chansw by p2p while gtk in progress */
...
/* retained for precommit auto-merging errors; remove once all branches are
 * synced */
#define WLC_E_REASON_REQUESTED_ROAM 11
#define WLC_E_REASON_BSSTRANS_REQ                                              \
    11 /* roamed due to BSS Transition request by AP */
#define WLC_E_REASON_LOW_RSSI_CU                                               \
    12 /* roamed due to low RSSI and Channel Usage */
#define WLC_E_REASON_RADAR_DETECTED                                            \
    13                              /* roamed due to radar detection by STA */
...
#define WLC_E_PRUNE_MAC_NA 4   /* STA's MAC addr is not in AP's MAC allow list \
                                */
#define WLC_E_PRUNE_REG_PASSV                                                  \
    5 /* AP not allowed due to regulatory restriction */
#define WLC_E_PRUNE_SPCT_MGMT                                                  \
    6                        /* AP does not support STA locale spectrum mgmt */
#define WLC_E_PRUNE_RADAR 7  /* AP is on a radar channel of STA locale */
#define WLC_E_RSN_MISMATCH 8 /* STA does not support AP's RSN */
#define WLC_E_PRUNE_NO_COMMON_RATES 9 /* No rates in common with AP */
#define WLC_E_PRUNE_BASIC_RATES                                                \
    10 /* STA does not support all basic rates of BSS */
#ifdef BCMCCX
...
#define WLC_E_PRUNE_NO_DIAG_SUPPORT                                            \
    19 /* prune due to diagnostic mode not supported */
#endif /* BCMCCX */
...
#define WLC_E_SUP_PW_KEY_CIPHER 5 /* Unicast cipher mismatch in pairwise key   \
                                   */
#define WLC_E_SUP_MSG3_TOO_MANY_IE                                             \
    6 /* WPA IE contains > 1 RSN IE in key msg 3 */
...
#define WLC_E_SUP_GRP_KEY_CIPHER 10  /* Multicast cipher mismatch in group key \
                                      */
#define WLC_E_SUP_GRP_MSG1_NO_GTK                                              \
    11 /* encapsulated GTK missing from group msg 1 */
...
#define WLC_E_SUP_MSG1_PMKID_MISMATCH                                          \
    22 /* MSG1 PMKID not matched to PMKSA cache list */
...
typedef struct wlc_sup_ptk_update {
    ...
    uint16 pn_low;
    uint32
        pn_high; /* local highest PN of any tid of the key when M4 was sent */
} wlc_sup_ptk_update_t;

/* sub event of WLC_E_WSEC */
typedef enum { WLC_WSEC_EVENT_PTK_PN_SYNC_ERROR = 0x01 } wl_wsec_event_type_t;
...
#define WLC_E_LINK_ASSOC_FAIL                                                  \
    5 /* Link down because assoc to new AP during roaming failed */
...
typedef BWL_PRE_PACKED_STRUCT struct ndis_link_parms {
    ...
    uint32 max_link_speed; /* max possible datarate for link in units of 500
                              Kbit/s  */
...
#define WLC_E_PKT_FILTER_TIMEOUT                                               \
    1 /* Matching packet not received in last timeout seconds */
...
typedef enum { WL_INTF_PSTA = 1, WL_INTF_DWDS = 2 } wl_dpsta_intf_type;
...
/*
 * If you make changes to this enum, dont forget to update the mask (if need
 * be).
 */
typedef enum wl_nan_events {
    ...
    WL_NAN_EVENT_PEER_SCHED_UPD_NOTIF =
        37,                            /* Peer's schedule update notification */
...
typedef struct wl_event_radar_detect_data {
    ...
    uint16 target_chanspec;  /*  Target chanspec after detection of radar on
                                current_chanspec */
...
#define WL_E_MODESW_FLAG_MASK_DEVICE                                           \
    0x01u /* mask of device: belongs to local or peer */
#define WL_E_MODESW_FLAG_MASK_FROM 0x02u /* mask of origin: firmware or user   \
                                          */
#define WL_E_MODESW_FLAG_MASK_STATE                                            \
    0x0Cu /* mask of state: modesw progress state */

#define WL_E_MODESW_FLAG_DEVICE_LOCAL                                          \
    0x00u /* flag - device: info is about self/local */
#define WL_E_MODESW_FLAG_DEVICE_PEER                                           \
    0x01u /* flag - device: info is about peer */

#define WL_E_MODESW_FLAG_FROM_FIRMWARE                                         \
    0x00u /* flag - from: request is from firmware */
#define WL_E_MODESW_FLAG_FROM_USER                                             \
    0x02u /* flag - from: request is from user/iov */

#define WL_E_MODESW_FLAG_STATE_REQUESTED                                       \
    0x00u /* flag - state: mode switch request */
#define WL_E_MODESW_FLAG_STATE_INITIATED                                       \
    0x04u /* flag - state: switch initiated */
#define WL_E_MODESW_FLAG_STATE_COMPLETE                                        \
    0x08u /* flag - state: switch completed/success */
#define WL_E_MODESW_FLAG_STATE_FAILURE                                         \
    0x0Cu /* flag - state: failed to switch */

/* Get sizeof *X including variable data's length where X is pointer to
...
#define WL_E_MODESW_DATA_SIZE(X)                                               \
    (((X)->length > sizeof(*(X))) ? ((X)->length - sizeof(*(X))) : 0)

#define WL_E_MODESW_REASON_UNKNOWN 0u /* reason: UNKNOWN */
#define WL_E_MODESW_REASON_ACSD 1u /* reason: ACSD (based on events from FW */
#define WL_E_MODESW_REASON_OBSS_DBS                                            \
    2u                            /* reason: OBSS DBS (eg. on interference) */
 ...
 * structure */
typedef struct {
    uint16 trigger; /* value 0: MU to SU, 1: SU to MU, 2: metric_dyn160,
                     * 3:re-/assoc, 4: disassoc, 5: rssi, 6: traffic, 7:
                     * interference, 8: chanim_stats
                     */
...
typedef enum ie_error_code { IE_ERROR_OUT_OF_RANGE = 0x01 } ie_error_code_t;
...
typedef enum {
    ...
    CHANSW_SLOTTED_BSS_CAL =
        30, /* channel switch due to Cal request from slotted bss */
...
/* WLC_E_ADPS status */
enum { WL_E_STATUS_ADPS_DEAUTH = 0, WL_E_STATUS_ADPS_MAX };
