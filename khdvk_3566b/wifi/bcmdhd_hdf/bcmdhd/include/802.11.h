...
#define DOT11_MAX_MPDU_LEN                                                     \
    (DOT11_A4_HDR_LEN + DOT11_QOS_LEN + DOT11_IV_AES_CCM_LEN +                 \
     DOT11_MAX_MPDU_BODY_LEN + DOT11_ICV_LEN +                                 \
...
#define DOT11_MAX_FRAG_LEN                                                     \
    2346 /* Max frag is also limited by aMPDUMaxLength                         \
          * of the attached PHY                                                \
          */
...
#define RFC1042_HDR_LEN                                                        \
    (ETHER_HDR_LEN + DOT11_LLC_SNAP_HDR_LEN) /* RCF1042 header length */
...
/**
 * RWL wifi protocol: The Vendor Specific Action frame is defined for
 * vendor-specific signaling category+OUI+vendor specific content ( this can be
 * variable)
 */
...
#define DOT11_AUTH_SEQ_STATUS_LEN                                              \
    4 /* length of auth frame without challenge IE and                         \
       * without algorithm                                                     \
       */
...
#define DOT11_ASSOC_REQ_FIXED_LEN                                              \
    4 /* length of assoc frame without info elts */
...
#define DOT11_REASSOC_REQ_FIXED_LEN                                            \
    10 /* length of assoc frame without info elts */
...
#define DOT11_ASSOC_RESP_FIXED_LEN                                             \
    6 /* length of assoc resp frame without info elts */
...
#define DOT11_MNG_IE_TPC_REPORT_LEN                                            \
    2 /* length of IE data, not including 2 byte header */
...
#define DOT11_SWITCH_IE_LEN                                                    \
    3 /* length of IE data, not including 2 byte header */
/* CSA mode - 802.11h-2003 $7.3.2.20 */
#define DOT11_CSA_MODE_ADVISORY                                                \
    0                          /* no DOT11_CSA_MODE_NO_TX restriction imposed */
...
#define DOT11_WIDE_BW_SWITCH_IE_LEN                                            \
    3 /* length of IE data, not including 2 byte header */
...
typedef struct dot11_vht_transmit_power_envelope
    dot11_vht_transmit_power_envelope_ie_t;
...
#define DOT11_TDLS_CAP_PU_BUFFER_STA                                           \
...
#define DOT11_MEASURE_TYPE_MCDIAGS                                             \
    10 /* d11 measurement multicast diagnostics */
...
#define DOT11_MEASURE_BASIC_MAP_BSS                                            \
    ((uint8)(1 << 0)) /* d11 measurement basic map BSS */
#define DOT11_MEASURE_BASIC_MAP_OFDM                                           \
    ((uint8)(1 << 1)) /* d11 measurement map OFDM */
#define DOT11_MEASURE_BASIC_MAP_UKNOWN                                         \
    ((uint8)(1 << 2)) /* d11 measurement map unknown */
#define DOT11_MEASURE_BASIC_MAP_RADAR                                          \
    ((uint8)(1 << 3)) /* d11 measurement map radar */
#define DOT11_MEASURE_BASIC_MAP_UNMEAS                                         \
    ((uint8)(1 << 4)) /* d11 measurement map unmeasuremnt */
...
#define DOT11_MNG_IE_MREQ_FIXED_LEN                                            \
    3 /* d11 measurement request IE fixed length */
...
#define DOT11_MNG_IE_MREQ_LCI_FIXED_LEN 4 /* d11 measurement report IE length  \
                                           */
#define DOT11_MNG_IE_MREQ_CIVIC_FIXED_LEN                                      \
    8 /* d11 measurement report IE length */
#define DOT11_MNG_IE_MREQ_FRNG_FIXED_LEN                                       \
    6 /* d11 measurement report IE length */
...
#define DOT11_MNG_IE_MREP_LCI_FIXED_LEN 5 /* d11 measurement report IE length  \
                                           */
#define DOT11_MNG_IE_MREP_CIVIC_FIXED_LEN                                      \
    6 /* d11 measurement report IE length */
#define DOT11_MNG_IE_MREP_LOCID_FIXED_LEN                                      \
    13 /* d11 measurement report IE length */
#define DOT11_MNG_IE_MREP_BASIC_FIXED_LEN                                      \
    15 /* d11 measurement report IE length */
#define DOT11_MNG_IE_MREP_FRNG_FIXED_LEN 4

/* length of Measure Report IE data not including variable len */
#define DOT11_MNG_IE_MREP_FIXED_LEN                                            \
    3 /* d11 measurement response IE fixed length */
...
BWL_PRE_PACKED_STRUCT struct dot11_qbss_load_ie {
    ...
    uint8 channel_utilization; /* % of time, normalized to 255, QAP sensed
                                  medium busy */
...
#define DOT11_ESP_INFO_LIST_AC_BK                                              \
    0u /* access category of esp information list AC_BK */
#define DOT11_ESP_INFO_LIST_AC_BE                                              \
    1u /* access category of esp information list AC_BE */
#define DOT11_ESP_INFO_LIST_AC_VI                                              \
    2u /* access category of esp information list AC_VI */
#define DOT11_ESP_INFO_LIST_AC_VO                                              \
...
#define FC_KIND(t, s)                                                          \
    (((t) << FC_TYPE_SHIFT) | ((s) << FC_SUBTYPE_SHIFT)) /* FC kind */

#define FC_SUBTYPE(fc)                                                         \
    (((fc)&FC_SUBTYPE_MASK) >> FC_SUBTYPE_SHIFT)           /* Subtype from FC */
#define FC_TYPE(fc) (((fc)&FC_TYPE_MASK) >> FC_TYPE_SHIFT) /* Type from FC */

#define FC_ASSOC_REQ                                                           \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_ASSOC_REQ) /* assoc. request */
#define FC_ASSOC_RESP                                                          \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_ASSOC_RESP) /* assoc. response */
#define FC_REASSOC_REQ                                                         \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_REASSOC_REQ) /* reassoc. request */
#define FC_REASSOC_RESP                                                        \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_REASSOC_RESP) /* reassoc. response */
#define FC_PROBE_REQ                                                           \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_PROBE_REQ) /* probe request */
#define FC_PROBE_RESP                                                          \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_PROBE_RESP)           /* probe response */
...
#define FC_ACTION_NOACK                                                        \
    FC_KIND(FC_TYPE_MNG, FC_SUBTYPE_ACTION_NOACK) /* action no-ack */

#define FC_CTL_TRIGGER                                                         \
    FC_KIND(FC_TYPE_CTL, FC_SUBTYPE_TRIGGER) /* Trigger frame */
#define FC_CTL_WRAPPER                                                         \
    FC_KIND(FC_TYPE_CTL, FC_SUBTYPE_CTL_WRAPPER) /* Control Wrapper */
#define FC_BLOCKACK_REQ                                                        \
    FC_KIND(FC_TYPE_CTL, FC_SUBTYPE_BLOCKACK_REQ) /* Block Ack Req */
...
#define FC_CF_END_ACK                                                          \
    FC_KIND(FC_TYPE_CTL, FC_SUBTYPE_CF_END_ACK) /* CF-END ACK */
...
#define FC_DATA_CF_ACK                                                         \
    FC_KIND(FC_TYPE_DATA, FC_SUBTYPE_DATA_CF_ACK)              /* data CF ACK */
...
#define QOS_PRIO(qos)                                                          \
    (((qos)&QOS_PRIO_MASK) >> QOS_PRIO_SHIFT) /* QoS priority */
...
#define DOT11_RC_DEAUTH_LEAVING                                                \
    3                         /* Deauthenticated because sending station       \
                               * is leaving (or has left) IBSS or ESS          \
                               */
#define DOT11_RC_INACTIVITY 4 /* Disassociated due to inactivity */
#define DOT11_RC_BUSY                                                          \
    5 /* Disassociated because AP is unable to handle                          \
       * all currently associated stations                                     \
       */
#define DOT11_RC_INVAL_CLASS_2                                                 \
    6 /* Class 2 frame received from                                           \
       * nonauthenticated station                                              \
       */
#define DOT11_RC_INVAL_CLASS_3                                                 \
    7 /* Class 3 frame received from                                           \
       *  nonassociated station                                                \
       */
#define DOT11_RC_DISASSOC_LEAVING                                              \
    8 /* Disassociated because sending station is                              \
       * leaving (or has left) BSS                                             \
       */
#define DOT11_RC_NOT_AUTH                                                      \
    9                            /* Station requesting (re)association is not  \
...
#define DOT11_RC_TX_OUTSIDE_TXOP                                               \
    35                            /* transmitting outside the limits of txop */
...
#define DOT11_SC_TDLS_WAKEUP_SCH_ALT                                           \
    2 /* TDLS wakeup schedule rejected but alternative  */
      /* schedule provided */
...
#define DOT11_SC_CAP_MISMATCH                                                  \
    10 /* Cannot support all requested                                         \
        * capabilities in the Capability                                       \
        * Information field                                                    \
        */
#define DOT11_SC_REASSOC_FAIL                                                  \
    11 /* Reassociation denied due to inability                                \
        * to confirm that association exists                                   \
        */
#define DOT11_SC_ASSOC_FAIL                                                    \
    12 /* Association denied due to reason                                     \
        * outside the scope of this standard                                   \
        */
#define DOT11_SC_AUTH_MISMATCH                                                 \
    13 /* Responding station does not support                                  \
        * the specified authentication                                         \
        * algorithm                                                            \
        */
#define DOT11_SC_AUTH_SEQ                                                      \
    14 /* Received an Authentication frame                                     \
        * with authentication transaction                                      \
        * sequence number out of expected                                      \
        * sequence                                                             \
        */
#define DOT11_SC_AUTH_CHALLENGE_FAIL                                           \
    15 /* Authentication rejected because of                                   \
        * challenge failure                                                    \
        */
#define DOT11_SC_AUTH_TIMEOUT                                                  \
    16 /* Authentication rejected due to timeout                               \
        * waiting for next frame in sequence                                   \
        */
#define DOT11_SC_ASSOC_BUSY_FAIL                                               \
    17 /* Association denied because AP is                                     \
        * unable to handle additional                                          \
        * associated stations                                                  \
        */
#define DOT11_SC_ASSOC_RATE_MISMATCH                                           \
    18 /* Association denied due to requesting                                 \
        * station not supporting all of the                                    \
        * data rates in the BSSBasicRateSet                                    \
        * parameter                                                            \
        */
#define DOT11_SC_ASSOC_SHORT_REQUIRED                                          \
    19 /* Association denied due to requesting                                 \
        * station not supporting the Short                                     \
        * Preamble option                                                      \
        */
#define DOT11_SC_ASSOC_PBCC_REQUIRED                                           \
    20 /* Association denied due to requesting                                 \
        * station not supporting the PBCC                                      \
        * Modulation option                                                    \
        */
#define DOT11_SC_ASSOC_AGILITY_REQUIRED                                        \
    21 /* Association denied due to requesting                                 \
        * station not supporting the Channel                                   \
        * Agility option                                                       \
        */
#define DOT11_SC_ASSOC_SPECTRUM_REQUIRED                                       \
    22 /* Association denied because Spectrum                                  \
        * Management capability is required.                                   \
        */
#define DOT11_SC_ASSOC_BAD_POWER_CAP                                           \
    23 /* Association denied because the info                                  \
        * in the Power Cap element is                                          \
        * unacceptable.                                                        \
        */
#define DOT11_SC_ASSOC_BAD_SUP_CHANNELS                                        \
    24 /* Association denied because the info                                  \
        * in the Supported Channel element is                                  \
        * unacceptable                                                         \
        */
#define DOT11_SC_ASSOC_SHORTSLOT_REQUIRED                                      \
    25 /* Association denied due to requesting                                 \
        * station not supporting the Short Slot                                \
        * Time option                                                          \
        */
#define DOT11_SC_ASSOC_DSSSOFDM_REQUIRED                                       \
    26 /* Association denied because requesting station                        \
        * does not support the DSSS-OFDM option                                \
        */
#define DOT11_SC_ASSOC_HT_REQUIRED                                             \
    27 /* Association denied because the requesting                            \
        * station does not support HT features                                 \
        */
#define DOT11_SC_ASSOC_R0KH_UNREACHABLE                                        \
    28 /* Association denied due to AP                                         \
        * being unable to reach the R0 Key Holder                              \
        */
#define DOT11_SC_ASSOC_TRY_LATER                                               \
    30 /* Association denied temporarily, try again later                      \
        */
#define DOT11_SC_ASSOC_MFP_VIOLATION                                           \
    31 /* Association denied due to Robust Management                          \
...
#define DOT11_SC_DLS_NOT_ALLOWED                                               \
    48                            /* DLS is not allowed in the BSS by policy */
...
#define DOT11_SC_ASSOC_VHT_REQUIRED                                            \
    104 /* Association denied because the requesting                           \
...
#define DOT11_MNG_MEASUREMENT_PILOT_TX_ID                                      \
    66 /* 11k measurement pilot tx info id */
#define DOT11_MNG_BSS_AVAL_ADMISSION_CAP_ID                                    \
    67                                      /* 11k bss aval admission cap id */
...
#define DOT11_MNG_HT_BSS_CHANNEL_REPORT_ID                                     \
    73                          /* d11 mgmt OBSS Intolerant Channel list */
#define DOT11_MNG_HT_OBSS_ID 74 /* d11 mgmt OBSS HT info */
#define DOT11_MNG_MMIE_ID 76    /* d11 mgmt MIC IE */
#define DOT11_MNG_NONTRANS_BSSID_CAP_ID                                        \
    83 /* 11k nontransmitted BSSID capability */
...
#define DOT11_MNG_CHANNEL_SWITCH_TIMING_ID                                     \
    104                              /* 11z TDLS Channel Switch Timing IE */
...
#define DOT11_MNG_VHT_TRANSMIT_POWER_ENVELOPE_ID                               \
    195 /* VHT transmit Power Envelope IE */
...
#define DOT11_MNG_OWE_DH_PARAM_ID                                              \
    (DOT11_MNG_ID_EXT_ID + EXT_MNG_OWE_DH_PARAM_ID)
...
#define DOT11_MNG_BSSCOLOR_CHANGE_ID                                           \
    (DOT11_MNG_ID_EXT_ID + EXT_MNG_BSSCOLOR_CHANGE_ID)

/* FILS and OCE ext ids */
#define FILS_EXTID_MNG_REQ_PARAMS 2u /* FILS Request Parameters element */
#define DOT11_MNG_FILS_REQ_PARAMS                                              \
    (DOT11_MNG_ID_EXT_ID + FILS_EXTID_MNG_REQ_PARAMS)
#define FILS_EXTID_MNG_KEY_CONFIRMATION_ID                                     \
    3u /* FILS Key Confirmation element */
#define DOT11_MNG_FILS_KEY_CONFIRMATION                                        \
    (DOT11_MNG_ID_EXT_ID + FILS_EXTID_MNG_KEY_CONFIRMATION_ID)
...
#define DOT11_MNG_FILS_HLP_CONTAINER                                           \
    (DOT11_MNG_ID_EXT_ID + FILS_EXTID_MNG_HLP_CONTAINER_ID)
#define FILS_EXTID_MNG_KEY_DELIVERY_ID 7u /* FILS Key Delivery element */
#define DOT11_MNG_FILS_KEY_DELIVERY                                            \
    (DOT11_MNG_ID_EXT_ID + FILS_EXTID_MNG_KEY_DELIVERY_ID)
#define FILS_EXTID_MNG_WRAPPED_DATA_ID 8u /* FILS Wrapped Data element */
#define DOT11_MNG_FILS_WRAPPED_DATA                                            \
    (DOT11_MNG_ID_EXT_ID + FILS_EXTID_MNG_WRAPPED_DATA_ID)
...
#define DOT11_MNG_IE_ID_EXT_MATCH(_ie, _id)                                    \
    (((_ie)->id == DOT11_MNG_ID_EXT_ID) && ((_ie)->len > 0) &&                 \
     ((_id) == ((uint8 *)(_ie) + TLV_HDR_LEN)[0]))

#define DOT11_MNG_IE_ID_EXT_INIT(_ie, _id, _len)                               \
    do {                                                                       \
 ...
 * and 5MHz, {1.5, 2.25, 3, 4.5, 13.5}, which are not supported by Broadcom
 * devices.
 */
 ...
 * These selector values are advertised in Supported Rates and Extended
 * Supported Rates IEs in the supported rates list with the Basic rate bit set.
 * Constants below include the basic bit.
 */
#define DOT11_BSS_MEMBERSHIP_HT 0xFF /* Basic 0x80 + 127, HT Required to join  \
                                      */
#define DOT11_BSS_MEMBERSHIP_VHT                                               \
    0xFE /* Basic 0x80 + 126, VHT Required to join */
#define DOT11_BSS_MEMBERSHIP_HE 0xFD /* Basic 0x80 + 125, HE Required to join  \
                                      */

/* ERP info element bit values */
#define DOT11_MNG_ERP_LEN 1 /* ERP is currently 1 byte long */
#define DOT11_MNG_NONERP_PRESENT                                               \
    0x01 /* NonERP (802.11b) STAs are present                                  \
          *in the BSS                                                          \
          */
#define DOT11_MNG_USE_PROTECTION                                               \
    0x02 /* Use protection mechanisms for                                      \
          *ERP-OFDM frames                                                     \
          */
#define DOT11_MNG_BARKER_PREAMBLE                                              \
    0x04 /* Short Preambles: 0 == allowed,                                     \
          * 1 == not allowed                                                   \
          */
...
#define DOT11_OPER_MODE_RXNSS(mode)                                            \
    ((((mode)&DOT11_OPER_MODE_RXNSS_MASK) >> DOT11_OPER_MODE_RXNSS_SHIFT) + 1)
...
#define DOT11_OBSS_COEX_MNG_SUPPORT                                            \
    0x01 /* 20/40 BSS Coexistence Management support */
...
/* Public action ids */
#define DOT11_PUB_ACTION_BSS_COEX_MNG                                          \
    0 /* 20/40 Coexistence Management action id */
...
#define DOT11_PUB_ACTION_FTM_REQ_TRIGGER_START                                 \
    1u                                           /* FTM request start trigger */
...
/** TCLAS frame classifier type 4 parameters for IPV4 is the same as TCLAS type
 * 1 */
...
/** TFS response subelement IDs (same subelments, but different IDs than in TFS
 * request */
...
#define DOT11_WNM_SLEEP_SUBELEM_GTK_FIXED_LEN                                  \
    11 /* without sub_id, len, and key */
...
#define DOT11_RMREQ_BCN_REPINFO_LEN 2 /* Beacon Reporting Information length   \
                                       */
#define DOT11_RMREQ_BCN_REPCOND_DEFAULT                                        \
...
typedef struct dot11_rmrep_last_bcn_rpt_ind_req
    dot11_rmrep_last_bcn_rpt_ind_req_t;
...
typedef struct dot11_rmrep_bcn_frm_body_fragmt_id
    dot11_rmrep_bcn_frm_body_fragmt_id_t;
...
typedef struct dot11_rmrep_bcn_frm_body_frag_id
    dot11_rmrep_bcn_frm_body_frag_id_t;
#define DOT11_RMREP_BCNRPT_FRAG_ID_DATA_LEN 2u
#define DOT11_RMREP_BCNRPT_FRAG_ID_SE_LEN                                      \
    sizeof(dot11_rmrep_bcn_frm_body_frag_id_t)
#define DOT11_RMREP_BCNRPT_FRAG_ID_NUM_SHIFT 1u
#define DOT11_RMREP_BCNRPT_FRAGMT_ID_SE_LEN                                    \
    sizeof(dot11_rmrep_bcn_frm_body_fragmt_id_t)
...
#define DOT11_RMREP_LAST_BCN_RPT_IND_SE_LEN                                    \
...
#define APHY_DIFS_TIME                                                         \
    (APHY_SIFS_TIME + (2 * APHY_SLOT_TIME)) /* APHY DIFS time */
...
/* brcm_ie flags */
#define BRF_ABCAP                                                              \
    0x1 /* afterburner is obsolete,  defined for backward compat */
#define BRF_ABRQRD                                                             \
    0x2 /* afterburner is obsolete,  defined for backward compat */
#define BRF_LZWDS 0x4    /* lazy wds enabled */
#define BRF_BLOCKACK 0x8 /* BlockACK capable */
#define BRF_ABCOUNTER_MASK                                                     \
    0xf0 /* afterburner is obsolete,  defined for backward compat */
#define BRF_PROP_11N_MCS 0x10 /* re-use afterburner bit */
#define BRF_MEDIA_CLIENT                                                       \
    0x20 /* re-use afterburner bit to indicate media client device */
...
BWL_PRE_PACKED_STRUCT struct relmcast_brcm_prop_ie {
    ...
    uint8 updtmo; /* time interval(second) for client to send null packet to
                     report its rssi */
} BWL_POST_PACKED_STRUCT;
typedef struct relmcast_brcm_prop_ie relmcast_brcm_prop_ie_t;

/* IE length */
/* BRCM_PROP_IE_LEN = sizeof(relmcast_brcm_prop_ie_t)-((sizeof (id) + sizeof
 * (len)))? */
#define RELMCAST_BRCM_PROP_IE_LEN                                              \
    (sizeof(relmcast_brcm_prop_ie_t) - (2 * sizeof(uint8)))
...
#define BTC_INFO_BRCM_PROP_IE_TYPE 90
#define BRCM_BTC_INFO_TYPE_LEN                                                 \
    (sizeof(btc_brcm_prop_ie_t) - (2 * sizeof(uint8)))

/* ************* HT definitions. ************* */
#define MCSSET_LEN                                                             \
    16 /* 16-bits per 8-bit set to give 128-bits bitmap of MCS Index */
...
/* CAP IE: HT 1.0 spec. simply stole a 802.11 IE, we use our prop. IE until this
 * is resolved */
...
#define HT_CAP_RX_STBC_ONE_STREAM 0x1 /* rx STBC support of 1 spatial stream   \
                                       */
#define HT_CAP_RX_STBC_TWO_STREAM                                              \
    0x2 /* rx STBC support of 1-2 spatial streams */
#define HT_CAP_RX_STBC_THREE_STREAM                                            \
    0x3 /* rx STBC support of 1-3 spatial streams */
...
#define HT_CAP_MCS_FLAGS_SUPP_BYTE                                             \
    12 /* byte offset in HT Cap Supported MCS for various flags */
...
#define AMPDU_RX_FACTOR_BASE_PWR                                               \
    13 /* ampdu factor base for rx len in power of 2 */

#define AMPDU_DELIMITER_LEN 4u /* length of ampdu delimiter */
#define AMPDU_DELIMITER_LEN_MAX                                                \
    63 /* max length of ampdu delimiter(enforced in HW) */
...
/* ADD IE: HT 1.0 spec. simply stole a 802.11 IE, we use our prop. IE until this
 * is resolved */
...
#define HT_OPMODE_CCFS2_MASK                                                   \
    0x1fe0                      /* Channel Center Frequency Segment 2 mask */
...
/* Tx Burst Limits */
#define DOT11N_2G_TXBURST_LIMIT                                                \
    6160 /* 2G band Tx burst limit per 802.11n Draft 1.10 (usec) */
#define DOT11N_5G_TXBURST_LIMIT                                                \
    3080 /* 5G band Tx burst limit per 802.11n Draft 1.10 (usec) */
...
#define HT_CAP_MCS_TX_STREAM_SUPPORT(supp_mcs)                                 \
    ((supp_mcs)[HT_CAP_MCS_FLAGS_SUPP_BYTE] &                                  \
     HT_CAP_MCS_FLAGS_MAX_SPATIAL_STREAM_MASK)
...
#define DOT11_OBSS_SCAN_IE_LEN                                                 \
    sizeof(obss_params_t) /* HT OBSS len (based on 802.11n d3.0) */

/* HT control field */
#define HT_CTRL_LA_TRQ 0x00000002 /* sounding request */
#define HT_CTRL_LA_MAI                                                         \
    0x0000003C /* MCS request or antenna selection indication */
...
#define HT_CTRL_LA_MFB_ASELC                                                   \
    0x0000FE00 /* MCS feedback, antenna selection command/data */
...
#define VHT_CAP_EXT_NSS_BW_SUP(cap_info)                                       \
    (((cap_info)&VHT_CAP_INFO_EXT_NSS_BW_SUP_MASK) >>                          \
     VHT_CAP_INFO_EXT_NSS_BW_SUP_SHIFT)

/* VHT CAP INFO extended NSS BW support - refer to IEEE 802.11 REVmc D8.0 Figure
 * 9-559 */
#define VHT_CAP_INFO_EXT_NSS_BW_HALF_160 1 /* 160MHz at half NSS CAP */
#define VHT_CAP_INFO_EXT_NSS_BW_HALF_160_80P80                                 \
    2 /* 160 & 80p80 MHz at half NSS CAP */
...
#define VHT_MCS_CODE_TO_MCS_MAP(mcs_code)                                      \
    ((mcs_code == VHT_CAP_MCS_MAP_0_7)   ? VHT_CAP_MCS_0_7_RATEMAP             \
     ...
     : (mcs_code == VHT_CAP_MCS_MAP_0_9) ? VHT_CAP_MCS_0_9_RATEMAP             \
                                         : 0)
...
#define VHT_MCS_MAP_TO_MCS_CODE(mcs_map)                                       \
    ((mcs_map == VHT_CAP_MCS_0_7_RATEMAP)   ? VHT_CAP_MCS_MAP_0_7              \
     ...
     : (mcs_map == VHT_CAP_MCS_0_9_RATEMAP) ? VHT_CAP_MCS_MAP_0_9              \
                                            : VHT_CAP_MCS_MAP_NONE)

#define VHT_PROP_MCS_MAP_TO_PROP_MCS_CODE(mcs_map)                             \
    (((mcs_map & 0xc00) == 0xc00) ? VHT_PROP_MCS_MAP_10_11                     \
...
typedef enum vht_op_chan_width {
    ...
    VHT_OP_CHAN_WIDTH_160 =
        2, /* deprecated - IEEE 802.11 REVmc D8.0 Table 11-25 */
    VHT_OP_CHAN_WIDTH_80_80 =
        3 /* deprecated - IEEE 802.11 REVmc D8.0 Table 11-25 */
} vht_op_chan_width_t;
...
#define VHT_MCS_MAP_SET_MCS_PER_SS(nss, numMcs, mcsMap)                        \
    do {                                                                       \
        ...
        (mcsMap) |=                                                            \
            (((numMcs)&VHT_CAP_MCS_MAP_M) << VHT_MCS_MAP_GET_SS_IDX(nss));     \
    } while (0)
...
#define VHT_MAX_SS_SUPPORTED(mcsMap)                                           \
    ...
    : VHT_MCS_SS_SUPPORTED(1, mcsMap) ? 1                                      \
                                      : 0
...
#ifdef FT_IE_VER_V2
#define DOT11_FT_IE_LEN(mic_len)                                               \
    (sizeof(dot11_ft_ie_v2) + mic_len + EAPOL_WPA_KEY_NONCE_LEN * 2)
#define FT_IE_MIC(pos) ((uint8 *)pos + sizeof(dot11_ft_ie_v2))
#define FT_IE_ANONCE(pos, mic_len)                                             \
    ((uint8 *)pos + sizeof(dot11_ft_ie_v2) + mic_len)
#define FT_IE_SNONCE(pos, mic_len)                                             \
    ((uint8 *)pos + sizeof(dot11_ft_ie_v2) + mic_len + EAPOL_WPA_KEY_NONCE_LEN)
#else
...
#define DOT11_FTM_ERR_NOT_CONT(_err)                                           \
    (((_err)[DOT11_FTM_ERR_NOT_CONT_OFFSET] & DOT11_FTM_ERR_NOT_CONT_MASK) >>  \
     DOT11_FTM_ERR_NOT_CONT_SHIFT)
#define DOT11_FTM_ERR_SET_NOT_CONT(_err, _val)                                 \
    do {                                                                       \
        uint8 _err2 = (_err)[DOT11_FTM_ERR_NOT_CONT_OFFSET];                   \
        _err2 &= ~DOT11_FTM_ERR_NOT_CONT_MASK;                                 \
        _err2 |= ((_val) << DOT11_FTM_ERR_NOT_CONT_SHIFT) &                    \
                 DOT11_FTM_ERR_NOT_CONT_MASK;                                  \
...
#define DOT11_FTM_ERR_SET_MAX_ERR(_err, _val)                                  \
    do {                                                                       \
        uint16 _val2;                                                          \
        uint16 _not_cont;                                                      \
        _val2 = (((_val)&DOT11_FTM_ERR_MAX_ERR_MASK)                           \
...
#define DOT11_FTM_ERR_SET_MAX_ERR(_err, _val)                                  \
    do {                                                                       \
        ...
        _val2 = (((_val) << DOT11_FTM_ERR_MAX_ERR_SHIFT) |                     \
                 ((_err)[DOT11_FTM_ERR_NOT_CONT_OFFSET] &                      \
                  DOT11_FTM_ERR_NOT_CONT_MASK));                               \
        (_err)[0] = _val2 & 0xff;                                              \
        (_err)[1] = _val2 >> 8 & 0xff;                                         \
    } while (0)
...
#define FTM_PARAMS_FIELD(_p, _off, _mask, _shift)                              \
    (((_p)->info[(_off)] & (_mask)) >> (_shift))
#define FTM_PARAMS_SET_FIELD(_p, _off, _mask, _shift, _val)                    \
    do {                                                                       \
...
#define FTM_PARAMS_STATUS(_p)                                                  \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_STATUS_OFFSET, FTM_PARAMS_STATUS_MASK,     \
                     FTM_PARAMS_STATUS_SHIFT)
#define FTM_PARAMS_SET_STATUS(_p, _status)                                     \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_STATUS_OFFSET, FTM_PARAMS_STATUS_MASK, \
                         FTM_PARAMS_STATUS_SHIFT, _status)

#define FTM_PARAMS_VALUE_OFFSET 0
#define FTM_PARAMS_VALUE_MASK 0x7c
#define FTM_PARAMS_VALUE_SHIFT 2
#define FTM_PARAMS_VALUE(_p)                                                   \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_VALUE_OFFSET, FTM_PARAMS_VALUE_MASK,       \
                     FTM_PARAMS_VALUE_SHIFT)
#define FTM_PARAMS_SET_VALUE(_p, _value)                                       \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_VALUE_OFFSET, FTM_PARAMS_VALUE_MASK,   \
                         FTM_PARAMS_VALUE_SHIFT, _value)
...
#define FTM_PARAMS_NBURSTEXP(_p)                                               \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_NBURSTEXP_OFFSET,                          \
                     FTM_PARAMS_NBURSTEXP_MASK, FTM_PARAMS_NBURSTEXP_SHIFT)
#define FTM_PARAMS_SET_NBURSTEXP(_p, _bexp)                                    \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_NBURSTEXP_OFFSET,                      \
                         FTM_PARAMS_NBURSTEXP_MASK,                            \
                         FTM_PARAMS_NBURSTEXP_SHIFT, _bexp)

#define FTM_PARAMS_NBURST(_p) (1 << FTM_PARAMS_NBURSTEXP(_p))

enum { FTM_PARAMS_NBURSTEXP_NOPREF = 15 };

enum { FTM_PARAMS_BURSTTMO_NOPREF = 15 };

#define FTM_PARAMS_BURSTTMO_OFFSET 1
#define FTM_PARAMS_BURSTTMO_MASK 0xf0
#define FTM_PARAMS_BURSTTMO_SHIFT 4
#define FTM_PARAMS_BURSTTMO(_p)                                                \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_BURSTTMO_OFFSET, FTM_PARAMS_BURSTTMO_MASK, \
                     FTM_PARAMS_BURSTTMO_SHIFT)
/* set timeout in params using _tmo where timeout = 2^(_tmo) * 250us */
#define FTM_PARAMS_SET_BURSTTMO(_p, _tmo)                                      \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_BURSTTMO_OFFSET,                       \
                         FTM_PARAMS_BURSTTMO_MASK, FTM_PARAMS_BURSTTMO_SHIFT,  \
                         (_tmo) + 2)

#define FTM_PARAMS_BURSTTMO_USEC(_val) ((1 << ((_val)-2)) * 250)
#define FTM_PARAMS_BURSTTMO_VALID(_val)                                        \
    ((((_val) < 12 && (_val) > 1)) || (_val) == FTM_PARAMS_BURSTTMO_NOPREF)
...
#define FTM_PARAMS_MINDELTA_USEC(_p)                                           \
    ((_p)->info[FTM_PARAMS_MINDELTA_OFFSET] * 100)
#define FTM_PARAMS_SET_MINDELTA_USEC(_p, _delta)                               \
    do {                                                                       \
        (_p)->info[FTM_PARAMS_MINDELTA_OFFSET] = (_delta) / 100;               \
    } while (0)

enum { FTM_PARAMS_MINDELTA_NOPREF = 0 };

#define FTM_PARAMS_PARTIAL_TSF(_p) ((_p)->info[4] << 8 | (_p)->info[3])
#define FTM_PARAMS_SET_PARTIAL_TSF(_p, _partial_tsf)                           \
    do {                                                                       \
...
#define FTM_PARAMS_PTSFNOPREF(_p)                                              \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_PTSFNOPREF_OFFSET,                         \
                     FTM_PARAMS_PTSFNOPREF_MASK, FTM_PARAMS_PTSFNOPREF_SHIFT)
#define FTM_PARAMS_SET_PTSFNOPREF(_p, _nopref)                                 \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_PTSFNOPREF_OFFSET,                     \
                         FTM_PARAMS_PTSFNOPREF_MASK,                           \
...
#define FTM_PARAMS_ASAP(_p)                                                    \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_ASAP_OFFSET, FTM_PARAMS_ASAP_MASK,         \
                     FTM_PARAMS_ASAP_SHIFT)
#define FTM_PARAMS_SET_ASAP(_p, _asap)                                         \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_ASAP_OFFSET, FTM_PARAMS_ASAP_MASK,     \
                         FTM_PARAMS_ASAP_SHIFT, _asap)

/* FTM1 - AKA ASAP Capable */
#define FTM_PARAMS_FTM1_OFFSET 5
#define FTM_PARAMS_FTM1_MASK 0x02
#define FTM_PARAMS_FTM1_SHIFT 1
#define FTM_PARAMS_FTM1(_p)                                                    \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_FTM1_OFFSET, FTM_PARAMS_FTM1_MASK,         \
                     FTM_PARAMS_FTM1_SHIFT)
#define FTM_PARAMS_SET_FTM1(_p, _ftm1)                                         \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_FTM1_OFFSET, FTM_PARAMS_FTM1_MASK,     \
                         FTM_PARAMS_FTM1_SHIFT, _ftm1)
...
#define FTM_PARAMS_FTMS_PER_BURST(_p)                                          \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_FTMS_PER_BURST_OFFSET,                     \
                     FTM_PARAMS_FTMS_PER_BURST_MASK,                           \
                     FTM_PARAMS_FTMS_PER_BURST_SHIFT)
#define FTM_PARAMS_SET_FTMS_PER_BURST(_p, _nftms)                              \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_FTMS_PER_BURST_OFFSET,                 \
                         FTM_PARAMS_FTMS_PER_BURST_MASK,                       \
                         FTM_PARAMS_FTMS_PER_BURST_SHIFT, _nftms)

enum { FTM_PARAMS_FTMS_PER_BURST_NOPREF = 0 };

#define FTM_PARAMS_CHAN_INFO_OFFSET 6
#define FTM_PARAMS_CHAN_INFO_MASK 0xfc
#define FTM_PARAMS_CHAN_INFO_SHIFT 2
#define FTM_PARAMS_CHAN_INFO(_p)                                               \
    FTM_PARAMS_FIELD(_p, FTM_PARAMS_CHAN_INFO_OFFSET,                          \
                     FTM_PARAMS_CHAN_INFO_MASK, FTM_PARAMS_CHAN_INFO_SHIFT)
#define FTM_PARAMS_SET_CHAN_INFO(_p, _ci)                                      \
    FTM_PARAMS_SET_FIELD(_p, FTM_PARAMS_CHAN_INFO_OFFSET,                      \
                         FTM_PARAMS_CHAN_INFO_MASK,                            \
                         FTM_PARAMS_CHAN_INFO_SHIFT, _ci)

/* burst period - units of 100ms */
#define FTM_PARAMS_BURST_PERIOD(_p) (((_p)->info[8] << 8) | (_p)->info[7])
#define FTM_PARAMS_SET_BURST_PERIOD(_p, _bp)                                   \
    do {                                                                       \
        (_p)->info[7] = (_bp)&0xff;                                            \
...
enum { FTM_PARAMS_BURST_PERIOD_NOPREF = 0 };
...
/* the following definitions are *DEPRECATED* and moved to implemenetion files.
 * They are retained here because previous (May 2016) some branches use them
 */
...
#define DOT11_MNG_OWE_IE_ID_EXT_INIT(_ie, _id, _len)                           \
    do {                                                                       \
        (_ie)->id = DOT11_MNG_ID_EXT_ID;                                       \
        (_ie)->len = _len;                                                     \
        (_ie)->ext_id = _id;                                                   \
