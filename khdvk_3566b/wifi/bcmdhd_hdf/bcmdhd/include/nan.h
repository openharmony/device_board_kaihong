...
#define NAN_OPERATING_CLASS_LEN                                                \
    1                         /* operating class field length from NAN FAM */
#define NAN_CHANNEL_NUM_LEN 1 /* channel number field length 1 byte */

/* generic nan attribute total length */
#define NAN_ATTR_TOT_LEN(_nan_attr)                                            \
    (ltoh16_ua(((const uint8 *)(_nan_attr)) + NAN_ATTR_ID_LEN) +               \
     NAN_ATTR_HDR_LEN)
...
#define NAN_SOC_CHAN_5G_CH149                                                  \
    149 /* NAN 5G discovery channel if upper band allowed */
#define NAN_SOC_CHAN_5G_CH44                                                   \
    44 /* NAN 5G discovery channel if only lower band allowed */

/* size of ndc id */
#define NAN_DATA_NDC_ID_SIZE 6

#define NAN_AVAIL_ENTRY_LEN_RES0                                               \
    7 /* Avail entry len in FAM attribute for resolution 16TU */
#define NAN_AVAIL_ENTRY_LEN_RES1                                               \
    5 /* Avail entry len in FAM attribute for resolution 32TU */
#define NAN_AVAIL_ENTRY_LEN_RES2                                               \
    4 /* Avail entry len in FAM attribute for resolution 64TU */
...
#define NAN_MAPID_MAPID(_mapid)                                                \
    (((_mapid)&NAN_MAPID_MAPID_MASK) >> NAN_MAPID_MAPID_SHIFT)
#define NAN_MAPID_SET_SPECIFIC_MAPID(map_id)                                   \
    ((((map_id) << NAN_MAPID_MAPID_SHIFT) & NAN_MAPID_MAPID_MASK) |            \
     NAN_MAPID_SPECIFIC_MAP_MASK)
...
enum {
    ...
    NAN_ATTR_NDPE = 41,
    /* change NAN_ATTR_MAX_ID to max ids + 1, excluding
     * NAN_ATTR_VENDOR_SPECIFIC. This is used in nan_parse.c
     */
...
#define NAN_RANGING_MAP_CTRL_REPEAT_DW(_ctrl)                                  \
    (((_ctrl)&NAN_RANGING_MAP_CTRL_DUR_MASK) ? 16 : 1)
...
#define NAN_RANGE_SETUP_ATTR_OFFSET_TBM_INFO                                   \
    (OFFSETOF(wifi_nan_ranging_setup_attr_t, data))
...
#define NAN_FTM_SET_BURST_DUR(ftm, dur)                                        \
    (ftm |= (((dur + 2) & NAN_FTM_MAX_BURST_DUR_MASK)                          \
             << NAN_FTM_MAX_BURST_DUR_SHIFT))
#define NAN_FTM_SET_FTM_DELTA(ftm, delta)                                      \
    (ftm |= (((delta / 100) & NAN_FTM_MIN_FTM_DELTA_MASK)                      \
             << NAN_FTM_MIN_FTM_DELTA_SHIFT))
#define NAN_FTM_SET_NUM_FTM(ftm, delta)                                        \
    (ftm |= ((delta & NAN_FTM_NUM_FTM_MASK) << NAN_FTM_NUM_FTM_SHIFT))
#define NAN_FTM_SET_FORMAT_BW(ftm, delta)                                      \
    (ftm |= ((delta & NAN_FTM_FORMAT_BW_MASK) << NAN_FTM_FORMAT_BW_SHIFT))
/* set uint32 to attribute */
#define NAN_FTM_PARAMS_UINT32_TO_ATTR(ftm_u32, ftm_attr)                       \
    {                                                                          \
        ftm_attr[0] = ftm_u32 & 0xFF;                                          \
        ftm_attr[1] = (ftm_u32 >> 8) & 0xFF;                                   \
        ftm_attr[2] = (ftm_u32 >> 16) & 0xFF;                                  \
    }

/* get atrribute to uint32 */
#define NAN_FTM_PARAMS_ATTR_TO_UINT32(ftm_p, ftm_u32)                          \
    (ftm_u32 = ftm_p[0] | ftm_p[1] << 8 | ftm_p[2] << 16)
/* get param values from uint32 */
#define NAN_FTM_GET_BURST_DUR(ftm)                                             \
    (((ftm >> NAN_FTM_MAX_BURST_DUR_SHIFT) & NAN_FTM_MAX_BURST_DUR_MASK))
#define NAN_FTM_GET_BURST_DUR_USEC(_val)                                       \
    ((1 << ((_val)-2)) * FTM_PARAMS_BURSTTMO_FACTOR)
#define NAN_FTM_GET_FTM_DELTA(ftm)                                             \
    (((ftm >> NAN_FTM_MIN_FTM_DELTA_SHIFT) & NAN_FTM_MIN_FTM_DELTA_MASK) * 100)
#define NAN_FTM_GET_NUM_FTM(ftm)                                               \
    ((ftm >> NAN_FTM_NUM_FTM_SHIFT) & NAN_FTM_NUM_FTM_MASK)
#define NAN_FTM_GET_FORMAT_BW(ftm)                                             \
    ((ftm >> NAN_FTM_FORMAT_BW_SHIFT) & NAN_FTM_FORMAT_BW_MASK)
...
#define NAN_AVAIL_CTRL_COMM_CHANGED(_ctrl)                                     \
    ((_ctrl)&NAN_AVAIL_CTRL_COMM_CHANGED_MASK)
#define NAN_AVAIL_CTRL_POTEN_CHANGED_MASK 0x0020
#define NAN_AVAIL_CTRL_POTEN_CHANGED(_ctrl)                                    \
    ((_ctrl)&NAN_AVAIL_CTRL_POTEN_CHANGED_MASK)
#define NAN_AVAIL_CTRL_PUBLIC_CHANGED_MASK 0x0040
#define NAN_AVAIL_CTRL_PUBLIC_CHANGED(_ctrl)                                   \
    ((_ctrl)&NAN_AVAIL_CTRL_PUBLIC_CHANGED_MASK)
#define NAN_AVAIL_CTRL_NDC_CHANGED_MASK 0x0080
#define NAN_AVAIL_CTRL_NDC_CHANGED(_ctrl)                                      \
    ((_ctrl)&NAN_AVAIL_CTRL_NDC_CHANGED_MASK)
#define NAN_AVAIL_CTRL_MCAST_CHANGED_MASK 0x0100
#define NAN_AVAIL_CTRL_MCAST_CHANGED(_ctrl)                                    \
    ((_ctrl)&NAN_AVAIL_CTRL_MCAST_CHANGED_MASK)
#define NAN_AVAIL_CTRL_MCAST_CHG_CHANGED_MASK 0x0200
#define NAN_AVAIL_CTRL_MCAST_CHG_CHANGED(_ctrl)                                \
    ((_ctrl)&NAN_AVAIL_CTRL_MCAST_CHG_CHANGED_MASK)
#define NAN_AVAIL_CTRL_CHANGED_FLAGS_MASK 0x03f0

#define NAN_AVAIL_ENTRY_CTRL_AVAIL_TYPE_MASK 0x07
#define NAN_AVAIL_ENTRY_CTRL_AVAIL_TYPE(_flags)                                \
    ((_flags)&NAN_AVAIL_ENTRY_CTRL_AVAIL_TYPE_MASK)
#define NAN_AVAIL_ENTRY_CTRL_USAGE_MASK 0x18
#define NAN_AVAIL_ENTRY_CTRL_USAGE_SHIFT 3
#define NAN_AVAIL_ENTRY_CTRL_USAGE(_flags)                                     \
    (((_flags)&NAN_AVAIL_ENTRY_CTRL_USAGE_MASK) >>                             \
     NAN_AVAIL_ENTRY_CTRL_USAGE_SHIFT)
#define NAN_AVAIL_ENTRY_CTRL_UTIL_MASK 0xE0
#define NAN_AVAIL_ENTRY_CTRL_UTIL_SHIFT 5
#define NAN_AVAIL_ENTRY_CTRL_UTIL(_flags)                                      \
    (((_flags)&NAN_AVAIL_ENTRY_CTRL_UTIL_MASK) >>                              \
     NAN_AVAIL_ENTRY_CTRL_UTIL_SHIFT)
#define NAN_AVAIL_ENTRY_CTRL_RX_NSS_MASK 0xF00
#define NAN_AVAIL_ENTRY_CTRL_RX_NSS_SHIFT 8
#define NAN_AVAIL_ENTRY_CTRL_RX_NSS(_flags)                                    \
    (((_flags)&NAN_AVAIL_ENTRY_CTRL_RX_NSS_MASK) >>                            \
...
#define NAN_AVAIL_ENTRY_CTRL_BITMAP_PRESENT(_flags)                            \
    (((_flags)&NAN_AVAIL_ENTRY_CTRL_BITMAP_PRESENT_MASK) >>                    \
     NAN_AVAIL_ENTRY_CTRL_BITMAP_PRESENT_SHIFT)

#define NAN_TIME_BMAP_CTRL_BITDUR_MASK 0x07
#define NAN_TIME_BMAP_CTRL_BITDUR(_flags)                                      \
    ((_flags)&NAN_TIME_BMAP_CTRL_BITDUR_MASK)
#define NAN_TIME_BMAP_CTRL_PERIOD_MASK 0x38
#define NAN_TIME_BMAP_CTRL_PERIOD_SHIFT 3
#define NAN_TIME_BMAP_CTRL_PERIOD(_flags)                                      \
    (((_flags)&NAN_TIME_BMAP_CTRL_PERIOD_MASK) >>                              \
     NAN_TIME_BMAP_CTRL_PERIOD_SHIFT)
#define NAN_TIME_BMAP_CTRL_OFFSET_MASK 0x7FC0
#define NAN_TIME_BMAP_CTRL_OFFSET_SHIFT 6
#define NAN_TIME_BMAP_CTRL_OFFSET(_flags)                                      \
    (((_flags)&NAN_TIME_BMAP_CTRL_OFFSET_MASK) >>                              \
...
#define NAN_AVAIL_CHAN_LIST_NUM_ENTRIES(_ctrl)                                 \
    (((_ctrl)&NAN_AVAIL_CHAN_LIST_NUM_ENTRIES_MASK) >>                         \
...
#define NAN_NDL_TYPE_CHECK(_ndl, x)                                            \
    (((_ndl)->type_status & NAN_NDL_TYPE_MASK) == (x))
#define NAN_NDL_REQUEST(_ndl)                                                  \
    (((_ndl)->type_status & NAN_NDL_TYPE_MASK) == NDL_ATTR_TYPE_STATUS_REQUEST)
#define NAN_NDL_RESPONSE(_ndl)                                                 \
    (((_ndl)->type_status & NAN_NDL_TYPE_MASK) == NDL_ATTR_TYPE_STATUS_RESPONSE)
#define NAN_NDL_CONFIRM(_ndl)                                                  \
    (((_ndl)->type_status & NAN_NDL_TYPE_MASK) == NDL_ATTR_TYPE_STATUS_CONFIRM)

#define NAN_NDL_STATUS_SHIFT 4
#define NAN_NDL_STATUS_MASK 0xF0
#define NAN_NDL_CONT(_ndl)                                                     \
    (((_ndl)->type_status & NAN_NDL_STATUS_MASK) ==                            \
     NDL_ATTR_TYPE_STATUS_CONTINUED)
#define NAN_NDL_ACCEPT(_ndl)                                                   \
    (((_ndl)->type_status & NAN_NDL_STATUS_MASK) ==                            \
     NDL_ATTR_TYPE_STATUS_ACCEPTED)
#define NAN_NDL_REJECT(_ndl)                                                   \
    (((_ndl)->type_status & NAN_NDL_STATUS_MASK) ==                            \
...
#define NDL_ATTR_CTRL_IMSCHED_PRESENT                                          \
    (1 << NDL_ATTR_CTRL_IM_SCHED_PRESENT_SHIFT)
#define NDL_ATTR_CTRL_NDC_PRESENT (1 << NDL_ATTR_CTRL_NDC_ATTR_PRESENT_SHIFT)
#define NDL_ATTR_CTRL_NDL_QOS_PRESENT                                          \
    (1 << NDL_ATTR_CTRL_QOS_ATTR_PRESENT_SHIFT)
#define NDL_ATTR_CTRL_MAX_IDLE_PER_PRESENT                                     \
    (1 << NDL_ATTR_CTRL_MAX_IDLE_PER_PRESENT_SHIFT)

#define NA_NDL_IS_IMMUT_PRESENT(ndl)                                           \
    (((ndl)->ndl_ctrl) & NDL_ATTR_CTRL_IMSCHED_PRESENT)
#define NA_NDL_IS_PEER_ID_PRESENT(ndl)                                         \
    (((ndl)->ndl_ctrl) & NDL_ATTR_CTRL_PEER_ID_PRESENT)
#define NA_NDL_IS_MAX_IDLE_PER_PRESENT(ndl)                                    \
    (((ndl)->ndl_ctrl) & NDL_ATTR_CTRL_MAX_IDLE_PER_PRESENT)
...
#define NAN_DEV_CAP_RX_ANT(_ant)                                               \
    (((_ant)&NAN_DEV_CAP_RX_ANT_MASK) >> NAN_DEV_CAP_RX_ANT_SHIFT)
...
#define NAN_DEV_CAP_NDPE_ATTR_SUPPORT(_cap)                                    \
    ((_cap)&NAN_DEV_CAP_NDPE_ATTR_SUPPORT_MASK)
...
#define NAN_ULW_CTRL_CHAN_AVAIL(ctrl)                                          \
    ((ctrl & NAN_ULW_CTRL_CHAN_AVAIL_MASK) >> NAN_ULW_CTRL_CHAN_AVAIL_SHIFT)
...
#define NAN_ULW_CNT_DOWN_NO_EXPIRE                                             \
    0xFF /* ULWs doen't end until next sched update */
...
/* Used for both NDP Attribute and NDPE Attribute, since the structures are
 * identical */
...
#define NAN_NDP_REQUEST(_ndp)                                                  \
    (((_ndp)->type_status & NAN_NDP_TYPE_MASK) == NAN_NDP_TYPE_REQUEST)
#define NAN_NDP_RESPONSE(_ndp)                                                 \
    (((_ndp)->type_status & NAN_NDP_TYPE_MASK) == NAN_NDP_TYPE_RESPONSE)
#define NAN_NDP_CONFIRM(_ndp)                                                  \
    (((_ndp)->type_status & NAN_NDP_TYPE_MASK) == NAN_NDP_TYPE_CONFIRM)
#define NAN_NDP_SECURITY_INST(_ndp)                                            \
    (((_ndp)->type_status & NAN_NDP_TYPE_MASK) == NAN_NDP_TYPE_SECURITY)
#define NAN_NDP_TERMINATE(_ndp)                                                \
    (((_ndp)->type_status & NAN_NDP_TYPE_MASK) == NAN_NDP_TYPE_TERMINATE)
...
#define NAN_NDP_CONT(_ndp)                                                     \
    (((_ndp)->type_status & NAN_NDP_STATUS_MASK) == NAN_NDP_STATUS_CONT)
#define NAN_NDP_ACCEPT(_ndp)                                                   \
    (((_ndp)->type_status & NAN_NDP_STATUS_MASK) == NAN_NDP_STATUS_ACCEPT)
#define NAN_NDP_REJECT(_ndp)                                                   \
    (((_ndp)->type_status & NAN_NDP_STATUS_MASK) == NAN_NDP_STATUS_REJECT)
...
#define NAN_RNG_ACCEPT(_rsua)                                                  \
    (((_rsua)->type_status & NAN_RNG_STATUS_MASK) == NAN_RNG_STATUS_ACCEPT)
#define NAN_RNG_REJECT(_rsua)                                                  \
    (((_rsua)->type_status & NAN_RNG_STATUS_MASK) == NAN_RNG_STATUS_REJECT)
...
#define NAN_SCHED_ENTRY_SIZE(_entry)                                           \
    (NAN_SCHED_ENTRY_MIN_SIZE + (_entry)->tbmp_len)
...
#define NAN_DEV_ELE_MAPID_SET(_mapid_field, value)                             \
    do {                                                                       \
        ...
        (_mapid_field) |=                                                      \
            ((value << NAN_DEV_ELE_MAPID_SHIFT) & NAN_DEV_ELE_MAPID_MASK);     \
    } while (0);

#define NAN_DEV_ELE_MAPID_GET(_mapid_field)                                    \
    (((_mapid_field)&NAN_DEV_ELE_MAPID_MASK) >> NAN_DEV_ELE_MAPID_SHIFT)
...
#define NAN_SCHED_ENTRY_MAPID_GET(_mapid_field)                                \
    (((_mapid_field)&NAN_SCHED_ENTRY_MAPID_MASK) >> NAN_SCHED_ENTRY_MAPID_SHIFT)
...
#define NAN_NDC_SET_PROPOSED_FLAG(_attr, value)                                \
    do {                                                                       \
        ((_attr)->attr_cntrl &= ~NAN_NDC_ATTR_PROPOSED_NDC_MASK);              \
        ((_attr)->attr_cntrl |=                                                \
         (((value) << NAN_NDC_ATTR_PROPOSED_NDC_SHIFT) &                       \
          NAN_NDC_ATTR_PROPOSED_NDC_MASK));                                    \
    } while (0)
...
/* max length of variable length field (matching filter, service response
 * filter, or service info) in service descriptor attribute
 */
...
#define NAN_SDE_MULTICAST_M_TO_M(_sde)                                         \
    ((_sde)->control & NAN_SDE_CF_MULTICAST_TYPE)
#define NAN_SDE_QOS_REQUIRED(_sde) ((_sde)->control & NAN_SDE_CF_QOS_REQUIRED)
#define NAN_SDE_SECURITY_REQUIRED(_sde)                                        \
    ((_sde)->control & NAN_SDE_CF_SECURITY_REQUIRED)
#define NAN_SDE_RANGING_REQUIRED(_sde)                                         \
    ((_sde)->control & NAN_SDE_CF_RANGING_REQUIRED)
#define NAN_SDE_RANGE_PRESENT(_sde) ((_sde)->control & NAN_SDE_CF_RANGE_PRESENT)
#define NAN_SDE_SVC_UPD_IND_PRESENT(_sde)                                      \
    ((_sde)->control & NAN_SDE_CF_SVC_UPD_IND_PRESENT)
...
#define NAN_SEC_NCSSK_KEY_DESC_VER_SET(_val, _key_info)                        \
    do {                                                                       \
        (_key_info) &= ~NAN_SEC_NCSSK_DESC_MASK;                               \
        (_key_info) |=                                                         \
            (((_val) << NAN_SEC_NCSSK_DESC_SHIFT) & NAN_SEC_NCSSK_DESC_MASK);  \
    } while (0)
...
#define NAN_SEC_NCSSK_DESC_KEY_ERR_GET(_key_info)                              \
    (((_key_info)&NAN_SEC_NCSSK_DESC_KEY_ERR_MASK) >>                          \
     NAN_SEC_NCSSK_DESC_KEY_ERR_SHIFT)
...
#define NAN_SEC_NCSSK_DESC_KEY_REQ_GET(_key_info)                              \
    (((_key_info)&NAN_SEC_NCSSK_DESC_KEY_REQ_MASK) >>                          \
     NAN_SEC_NCSSK_DESC_KEY_REQ_SHIFT)
...
#define NAN_SEC_NCSSK_IEEE80211_KDESC_TYPE                                     \
    2                                     /* IEEE 802.11 Key Descriptor Type */
...
#define NAN_ALL_NAN_MGMT_FRAMES                                                \
    (NAN_FRM_SCHED_AF | NAN_FRM_NDP_AF | NAN_FRM_NDL_AF | NAN_FRM_DISC_BCN |   \
     ...
     NAN_FRM_RNG_RESP_AF | NAN_FRM_RNG_REPORT_AF | NAN_FRM_RNG_TERM_AF)
