 ...
 * define them entirely in this file.  We can't always define the types because
 * we get a duplicate typedef error; there is no way to "undefine" a typedef. We
...
#ifndef TYPEDEF_BOOL
typedef unsigned char bool; /* @abstract@ */
...
/* Avoid warning for discarded const or volatile qualifier in special cases
 * (-Wcast-qual) */
