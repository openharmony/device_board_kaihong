...
/** Retrieve named and bsscfg indexed IOVARs, this function calls wl_dev_ioctl
 * with WLC_GET_VAR IOCTL code
 */
...
extern void dhd_get_customized_country_code(struct net_device *dev,
