...
extern void dhd_prot_update_txflowring(dhd_pub_t *dhdp, uint16 flow_id,
                                       void *msgring_info);
...
#else
static INLINE void dhd_prot_update_pktid_txq_stop_cnt(dhd_pub_t *dhd)
{
    return;
}
static INLINE void dhd_prot_update_pktid_txq_start_cnt(dhd_pub_t *dhd)
{
    return;
}
#endif /* BCMPCIE */
