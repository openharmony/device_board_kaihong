...
typedef enum {
    ...
    OHOS_NL80211_SUBCMD_GSCAN_RANGE_START = 0x1000,
    OHOS_NL80211_SUBCMD_GSCAN_RANGE_END = 0x10FF,

    /* define all RTT related commands between 0x1100 and 0x11FF */
    OHOS_NL80211_SUBCMD_RTT_RANGE_START = 0x1100,
    OHOS_NL80211_SUBCMD_RTT_RANGE_END = 0x11FF,

    OHOS_NL80211_SUBCMD_LSTATS_RANGE_START = 0x1200,
    OHOS_NL80211_SUBCMD_LSTATS_RANGE_END = 0x12FF,

    OHOS_NL80211_SUBCMD_TDLS_RANGE_START = 0x1300,
    OHOS_NL80211_SUBCMD_TDLS_RANGE_END = 0x13FF,

    OHOS_NL80211_SUBCMD_DEBUG_RANGE_START = 0x1400,
    OHOS_NL80211_SUBCMD_DEBUG_RANGE_END = 0x14FF,

    /* define all NearbyDiscovery related commands between 0x1500 and 0x15FF */
    OHOS_NL80211_SUBCMD_NBD_RANGE_START = 0x1500,
    OHOS_NL80211_SUBCMD_NBD_RANGE_END = 0x15FF,

    /* define all wifi calling related commands between 0x1600 and 0x16FF */
    OHOS_NL80211_SUBCMD_WIFI_OFFLOAD_RANGE_START = 0x1600,
    OHOS_NL80211_SUBCMD_WIFI_OFFLOAD_RANGE_END = 0x16FF,

    /* define all NAN related commands between 0x1700 and 0x17FF */
    OHOS_NL80211_SUBCMD_NAN_RANGE_START = 0x1700,
    OHOS_NL80211_SUBCMD_NAN_RANGE_END = 0x17FF,

    /* define all packet filter related commands between 0x1800 and 0x18FF */
    OHOS_NL80211_SUBCMD_PKT_FILTER_RANGE_START = 0x1800,
    OHOS_NL80211_SUBCMD_PKT_FILTER_RANGE_END = 0x18FF,

    /* This is reserved for future usage */
} OHOS_VENDOR_SUB_COMMAND;

enum ohos_vendor_subcmd {
    GSCAN_SUBCMD_GET_CAPABILITIES = OHOS_NL80211_SUBCMD_GSCAN_RANGE_START,
    ...
    /* OHOS_WIFI_XXX although not related to gscan are defined here */
    OHOS_WIFI_SUBCMD_GET_FEATURE_SET,
    OHOS_WIFI_SUBCMD_GET_FEATURE_SET_MATRIX,
    OHOS_WIFI_RANDOM_MAC_OUI,
    OHOS_WIFI_NODFS_CHANNELS,
    OHOS_WIFI_SET_COUNTRY,
    GSCAN_SUBCMD_SET_EPNO_SSID,
    WIFI_SUBCMD_SET_SSID_ALLOWLIST,
    WIFI_SUBCMD_SET_LAZY_ROAM_PARAMS,
    WIFI_SUBCMD_ENABLE_LAZY_ROAM,
    WIFI_SUBCMD_SET_BSSID_PREF,
    WIFI_SUBCMD_SET_BSSID_DENYLIST,
    ...
    RTT_SUBCMD_SET_CONFIG = OHOS_NL80211_SUBCMD_RTT_RANGE_START,
    RTT_SUBCMD_CANCEL_CONFIG,
    RTT_SUBCMD_GETCAPABILITY,
    RTT_SUBCMD_GETAVAILCHANNEL,
    RTT_SUBCMD_SET_RESPONDER,
    RTT_SUBCMD_CANCEL_RESPONDER,
    LSTATS_SUBCMD_GET_INFO = OHOS_NL80211_SUBCMD_LSTATS_RANGE_START,

    DEBUG_START_LOGGING = OHOS_NL80211_SUBCMD_DEBUG_RANGE_START,
    ...
    WIFI_OFFLOAD_SUBCMD_START_MKEEP_ALIVE =
        OHOS_NL80211_SUBCMD_WIFI_OFFLOAD_RANGE_START,
    ...
    APF_SUBCMD_GET_CAPABILITIES = OHOS_NL80211_SUBCMD_PKT_FILTER_RANGE_START,
...
enum gscan_attributes {
    ...
    /* Roam SSID Allowlist and BSSID pref */
    GSCAN_ATTRIBUTE_ALLOWLIST_SSID = GSCAN_ATTR_SET8,
    GSCAN_ATTRIBUTE_NUM_WL_SSID,
    GSCAN_ATTRIBUTE_WL_SSID_LEN,
    GSCAN_ATTRIBUTE_WL_SSID_FLUSH,
    GSCAN_ATTRIBUTE_ALLOWLIST_SSID_ELEM,
    ...
    /* BSSID denylist */
    GSCAN_ATTRIBUTE_BSSID_DENYLIST_FLUSH = GSCAN_ATTR_SET10,
    GSCAN_ATTRIBUTE_DENYLIST_BSSID,
...
typedef enum wl_vendor_event {
    ...
    OHOS_GSCAN_SIGNIFICANT_EVENT = 2,
    OHOS_GSCAN_GEOFENCE_FOUND_EVENT = 3,
    OHOS_GSCAN_BATCH_SCAN_EVENT = 4,
    OHOS_SCAN_FULL_RESULTS_EVENT = 5,
    OHOS_RTT_COMPLETE_EVENT = 6,
    OHOS_SCAN_COMPLETE_EVENT = 7,
    OHOS_GSCAN_GEOFENCE_LOST_EVENT = 8,
    OHOS_SCAN_EPNO_EVENT = 9,
    OHOS_DEBUG_RING_EVENT = 10,
    OHOS_FW_DUMP_EVENT = 11,
    OHOS_PNO_HOTSPOT_FOUND_EVENT = 12,
    OHOS_RSSI_MONITOR_EVENT = 13,
    OHOS_MKEEP_ALIVE_EVENT = 14,
     ...
     */
    OHOS_NAN_EVENT_ENABLED = 15,
    OHOS_NAN_EVENT_DISABLED = 16,
    OHOS_NAN_EVENT_SUBSCRIBE_MATCH = 17,
    OHOS_NAN_EVENT_REPLIED = 18,
    OHOS_NAN_EVENT_PUBLISH_TERMINATED = 19,
    OHOS_NAN_EVENT_SUBSCRIBE_TERMINATED = 20,
    OHOS_NAN_EVENT_DE_EVENT = 21,
    OHOS_NAN_EVENT_FOLLOWUP = 22,
    OHOS_NAN_EVENT_TRANSMIT_FOLLOWUP_IND = 23,
    OHOS_NAN_EVENT_DATA_REQUEST = 24,
    OHOS_NAN_EVENT_DATA_CONFIRMATION = 25,
    OHOS_NAN_EVENT_DATA_END = 26,
    OHOS_NAN_EVENT_BEACON = 27,
    OHOS_NAN_EVENT_SDF = 28,
    OHOS_NAN_EVENT_TCA = 29,
    OHOS_NAN_EVENT_SUBSCRIBE_UNMATCH = 30,
    OHOS_NAN_EVENT_UNKNOWN = 31,
    OHOS_ROAM_EVENT_START = 32,
...
enum ohos_wifi_attr {
    OHOS_WIFI_ATTRIBUTE_NUM_FEATURE_SET,
    OHOS_WIFI_ATTRIBUTE_FEATURE_SET,
    OHOS_WIFI_ATTRIBUTE_RANDOM_MAC_OUI,
    OHOS_WIFI_ATTRIBUTE_NODFS_SET,
    OHOS_WIFI_ATTRIBUTE_COUNTRY,
    OHOS_WIFI_ATTRIBUTE_ND_OFFLOAD_VALUE,
    OHOS_WIFI_ATTRIBUTE_TCPACK_SUP_VALUE
};
enum apf_attributes {
...
typedef enum wl_vendor_gscan_attribute {
    ...
    ATTR_SET_SCAN_SIGNIFICANT_CFG_ID, /* set list of bssids, rssi threshold
                                         etc.. */
...
typedef struct wlan_driver_wake_reason_cnt_t {
    ...
    int *driver_fw_local_wake_cnt;  /* Individual wake count array, each index a
                                       reason */
    int driver_fw_local_wake_cnt_sz; /* Max number of local driver/fw wake
                                        reasons */
...
typedef struct wifi_roaming_capabilities {
    u32 max_denylist_size;
    u32 max_allowlist_size;
